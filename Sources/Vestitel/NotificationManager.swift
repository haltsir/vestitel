...
/// Local notifications — currently one case: a site started bot-challenging
/// the app's feed fetches, and the user may want to open it in a browser.
@MainActor
final class NotificationManager: NSObject, UNUserNotificationCenterDelegate {
    ...
    nonisolated func userNotificationCenter(
        ...
        guard response.actionIdentifier == Self.openSiteActionID
